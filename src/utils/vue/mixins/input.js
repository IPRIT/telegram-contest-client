import { loadable as Loadable } from './loadable';
import { validatable as Validatable } from './validatable';

// Icons
import MdClose from 'md-svg-vue/dist/navigation/MdClose.vue';

// Components
import RBtn from '../../../components/base/JsBtn/JsBtn.vue';
...
export const input = {
  ...
  methods: {
    ...
    genIcon (type, defaultCallback = null) {
      ...
      const wrapTag = shouldClear ? 'js-btn' : 'span';
    ...
    genInputGroup (input, data = {}, defaultAppendCallback = null) {
      ...
      children.push(
        !this.preserveDetails
          ? this.$createElement('js-expand-transition', {
            attrs: {
              mode: 'out-in'
            }
          }, [ detailsContainer ])
